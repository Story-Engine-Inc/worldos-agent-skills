...
| Custom domain data | Existing reusable widget, otherwise a public UGC widget | Create a widget only when no existing app expresses the state; a successful create publishes it immediately. |
